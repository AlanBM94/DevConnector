...
exports.getProfile = async (req, res) => {
    try {
        ...
        if (!profile) {
            return res
                .status(400)
                .json({ message: "No hay perfil de ese usuario" });
...
exports.getProfileByUserId = async (req, res) => {
    try {
        ...
        if (!profile) {
            return res
                .status(400)
                .json({ message: "No hay perfil con ese id de usuario" });
    ...
    try {
        ...
        request(options, (error, response, body) => {
            ...
            if (response.statusCode !== 200) {
                return res
                    .status(404)
                    .json({ message: "No se encontró un perfil de Github" });
                // .json({ message: "No github profile found" });
            }
        ...
        return res
            .status(404)
            .json({ msg: "No se encontró un perfil de Github" });
